...
for domain in domains:
    if DOMAIN == domain['name']:
        ...
        base_domain_report.append(
            f"<tr><td align='left'>{domain['name']}</td><td align='center'>{domain['description']}</td><td align='right'>{base_total_extensions}</td></tr>"
        )
        ...
        sub_domains_report.append(
            f"<tr><td align='center'>{domain['name']}</td><td align='center'>{domain['description']}</td><td align='right'>{domain_total_extensions}</td></tr>"
        )
